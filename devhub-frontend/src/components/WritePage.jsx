...
function WritePage() {
  ...
  return (
    <div className="h-screen bg-[#0A0A0A] text-white flex flex-col overflow-hidden">
      {/* HEADER */}
      <div className="sticky top-0 z-50 flex items-center justify-between px-6 py-3 border-b border-neutral-800 bg-[#09090B] shrink-0">
      ...
      <div className="flex-1 grid grid-cols-2 overflow-y-auto">
        {/* LEFT COLUMN: MARKDOWN EDITOR */}
        <div className="border-r border-neutral-800 p-8">
        ...
        <div className="p-8 bg-[#050505] overflow-y-auto">
